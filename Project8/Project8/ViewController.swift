...
class ViewController: UIViewController {
	...
	override func loadView() {
		...
		NSLayoutConstraint.activate([scoreLabel.topAnchor.constraint(equalTo: view.layoutMarginsGuide.topAnchor),
			...
			clear.heightAnchor.constraint(equalToConstant: 28),
	...
	@objc func submitTapped(_ sender: UIButton) {
		...
		if let solutionPosition = solutions.firstIndex(of: answerText) {
			...
			clearTapped(sender)
			score -= 1
			let ac = UIAlertController(title: "Whoops!", message: "That is not correct!", preferredStyle: .alert)
			ac.addAction(UIAlertAction(title: "I'll try again", style: .default))
			present(ac, animated: true)
		}
	}
